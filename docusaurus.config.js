    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: 'https://github.com/hongvin/server-documentation/',
        },
        blog: false,
        theme: {
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/hongvin/server-documentation',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        style: 'dark',
        copyright: `Copyright © ${new Date().getFullYear()} Server Documentation, by hongvin. Built with Docusaurus.`,
      },
      prism: {
